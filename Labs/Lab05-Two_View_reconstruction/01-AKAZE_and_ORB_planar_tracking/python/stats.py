class Stats:
    ...
    def __str__(self) -> str:
        return "matches({0}) inliner({1}) ratio({2:.2f}) keypoints({3}) fps({4:.2f})"\
            .format(self.matches, self.inliers, self.ratio, self.keypoints, self.fps)
    ...
    def to_strings(self):
        ...
        str2 = "Inliners: {0}".format(self.inliers)
        str3 = "Inliner ratio: {0:.2f}".format(self.ratio)
